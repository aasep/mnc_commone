...
$nama_nasabah=str_replace("'","",$_POST['nama_nasabah']);
$no_tlp=$_POST['no_tlp'];
...
$query=" insert into master_case (name,sla,satuan,priority,id_productbi,id_causebi,adddt,addby,stat_pmb,flag_mandatory,id_report) values ('$casename','$sla','$satuan','$prioritas','$biproduct','$bicase',CURRENT_TIMESTAMP,'".getUsername()."','$stat_pmb','$is_mandatory','$is_report') ";
$result=pg_query($connection, $query);
...
$stat_pmb=$_POST['stat_pmb'];
$is_mandatory=$_POST['is_mandatory'];
$ed_is_report=$_POST['ed_is_report'];

$query="  update  master_case set stat_pmb='$stat_pmb',id_causebi='$ed_bicase',id_productbi='$ed_biproduct',name='$ed_nama',sla='$ed_sla', ";
$query.=" priority='$ed_prioritas',satuan='$ed_satuan',flag_mandatory='$is_mandatory',id_report='$ed_is_report' where id_case='$id_case' ";
...
$id_process=$_POST['id_process'];
# MANDATORY
$keterangan=str_replace(array("'"),"", $_POST['keterangan']);
