...
/*
a.ticket_number,a.id_karyawan,a.date_start,a.customer_name,a.account_number,a.credit_card_number,a.phone,a.email,a.sla,a.date_sla,a.extend_sla,
a.nominal,a.keterangan,a.status
...
##############################  PROSES EXCEL =================================================  abcde
        ...
        while ($row_mncpay=pg_fetch_array($result)) {
                            ...
                            $jml_intval=$row_mncpay['sla']+$row_mncpay['extend_sla'];
                             $date_sla=dateSla($row_mncpay['date_start'],$jml_intval,$row_mncpay['satuan']);
               ...
               //$objPHPExcel->getActiveSheet()->setCellValue("K$i", $row_mncpay['phone']);
				...
				//$objPHPExcel->getActiveSheet()->setCellValue("X$i", substr(cleanStr(str_replace(array("<br>","br"), " ", $row_mncpay['keterangan'])),0,60));
				/*
                ...
                */
                ...
                //$objPHPExcel->getActiveSheet()->setCellValue("Z$i", substr(cleanStr(str_replace(array("<br>","br"), " ", lastMemoInfo($row_mncpay['ticket_number']))),0,60) );
...
ob_end_clean();
$objWriter->save("../../data/download/INQUIRY"."_".$file_eksport.".xls");
