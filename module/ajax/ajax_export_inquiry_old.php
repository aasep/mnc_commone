...
##############################  PROSES EXCEL =================================================  abcde
        ...
        while ($row_mncpay=pg_fetch_array($result)) {
               ...
               //$objPHPExcel->getActiveSheet()->setCellValue("I$i", $row_mncpay['account_number']);
				...
				$objPHPExcel->getActiveSheet()->setCellValue("X$i", $row_mncpay['keterangan']);
				/*
                ...
                */
                ...
                $objPHPExcel->getActiveSheet()->setCellValue("Z$i", lastMemoInfo($row_mncpay['ticket_number']));
...
//echo $row_mncpay['ticket_number']."<br>";
//" | ".lastMemoInfo($row_mncpay['ticket_number'])." | ".date('d-m-Y',strtotime(lastMemoDate($row_mncpay['ticket_number'])))."<br>";
...
//$objPHPExcel->getActiveSheet()->getStyle("I7:K$garis_akhir")->getNumberFormat()->setFormatCode(PHPExcel_Style_NumberFormat::FORMAT_NUMBER);
