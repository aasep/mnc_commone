...
<table class="table table-bordered table-hover" width="100%">
                                    ...
                                    <td width="20%">: <?php  echo $row_lap['extend_sla']." ".$row_lap['satuan']; ?> 
...
<div class="table-scrollable">
									...
									<tr bgcolor="#F0F0F0">
									<td>
										 <i class="fa fa-user-md font-blue"></i> <b> Basic Information Cutomer </b>
									</td>
									</tr>
									</table>
...
<div class="table-scrollable">
								<table class="table table-bordered table-hover" width="100%">
									<tr bgcolor="#F0F0F0">
									<td>
										<i class="fa fa-book font-blue"></i><b> Jenis laporan</b>
									</td>
									</tr>
									</table>
...
<div class="table-scrollable">
									...
									<tr>
                                    <td width="15%"></td>
                                    <td width="85%" align="right"><button class="btn btn-circle blue-hoki red-stripe btn-sm pull-right" data-toggle="modal" data-dismiss="modal" data-target="#lampiran-file" id="lampir-file"> <i class="fa fa-chain"> </i> <i>Attach file</i> </button></td>
									</tr>
									</table>
									</div>	
									</div>
