				...
				?>  <!--
					<div class="portlet box blue-hoki">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa"></i><b><?php echo $title;?> </b>
							</div>
						...
						<div class="portlet-body form">
							...
							<form action="<?php echo "module/actions_master.php?module=$module&act=$act&mode=1$var_lapker"; ?>" id="form_sample_3" class="form-horizontal" method="POST" enctype="multipart/form-data">
								...
								<strong>Cabang         : <?php echo getNamaCabang();?>
									...
									<td>
										 <b>Basic Information Customer</b>
									</td>
									</tr>
									</table>
								...
								<table width="100%">
                                   ...
                                   <td width="50%" >
									...
									<td>
									<div class="form-group">
										<label class="control-label col-md-4">No. Credit Card<span class="required">
										 </span>
										</label>
										<div class="input-group input-medium margin-top-10">
										<span class="input-group-addon">
									...
									<td>
									<div class="form-group">
										<label class="control-label col-md-4">ATM Number<span class="required">
										 </span>
										</label>
										<div class="input-group input-medium margin-top-10">
										<span class="input-group-addon">
...
<!--  NYELIP 2 -->             <div align="center" class="loading2" style="display:none">
								...
								<div  id="tabel-broadcast" align="center"></div>
										...
										<div class="modal-footer" style="text-align: center;"> 
											<a href="#" class="brodcastemail" idx-ticket="<?php echo $rowidx['ticket_number']; ?>"> <button type="button" class="btn blue" data-dismiss="modal"> Lanjut  <i class="fa fa-sign-in"></i> </button> </a>
