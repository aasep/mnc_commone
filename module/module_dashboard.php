...
//product B
	...
	$f_product= " where id_product='$idproduct' ";
               ...
               <?php if (isset($_GET['showdet']) && ($_GET['showdet']=='1' || $_GET['showdet']=='2' || $_GET['showdet']=='3' || $_GET['showdet']=='4')&& ($_GET['act']=='src')) { 
               	...
               	?>
						...
						<div class="portlet-body form">
                            ...
                            $query_modal .=" $var_product $var_modal  $var_unit $var_proses $var_case $var_cause $var_jslaporan $var_channel $varperiode  ";
                            //echo $query_modal;
               ...
               <div class="portlet light bordered">
									<div class="portlet-title">
										<div class="caption">
											...
											<span class="caption-subject font-green-haze bold uppercase">Filter Form</span>
											<span class="caption-helper">Filter By Product, unit, etc ...</span>
										</div>
                                   ...
                                   <td width="50%" >
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-6">
											<select class="form-control select2me" name="idproduct" id="idproduct" >
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					...
					<div class="dashboard-stat green-haze">
						...
						<a class="more bold" href="<?php echo "$page&act=src&showdet=1&idproduct=$idproduct&idunit=$idunit&idproses=$idproses&idpermasalahan=$idpermasalahan&idpenyebab=$idpenyebab&idjenis_laporan=$idjenis_laporan&from=$from&to=$to";?>">
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat blue-madison">
						...
						<a class="more bold" href="<?php echo "$page&act=src&showdet=2&idproduct=$idproduct&idunit=$idunit&idproses=$idproses&idpermasalahan=$idpermasalahan&idpenyebab=$idpenyebab&idjenis_laporan=$idjenis_laporan&from=$from&to=$to";?>">
						VIEW REPORT <i class="m-icon-swapright m-icon-white"></i>
						</a>
					</div>
				</div>
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat purple-plum">
						...
						<a class="more bold" href="<?php echo "$page&act=src&showdet=3&idproduct=$idproduct&idunit=$idunit&idproses=$idproses&idpermasalahan=$idpermasalahan&idpenyebab=$idpenyebab&idjenis_laporan=$idjenis_laporan&from=$from&to=$to";?>">
						VIEW REPORT <i class="m-icon-swapright m-icon-white"></i>
						</a>
					</div>
				</div>
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					...
					<div class="dashboard-stat red-intense">
						...
						<a class="more bold" href="<?php echo "$page&act=src&showdet=4&idproduct=$idproduct&idunit=$idunit&idproses=$idproses&idpermasalahan=$idpermasalahan&idpenyebab=$idpenyebab&idjenis_laporan=$idjenis_laporan&from=$from&to=$to";?>">
						VIEW REPORT <i class="m-icon-swapright m-icon-white"></i>
						</a>
					</div>
				</div>
					...
					<table class="table table-striped table-bordered table-hover"  width="100%">
							...
							$q_product ="  select * from master_product $f_product order by name asc ";
							$res_product=pg_query($connection,$q_product);
							while ($row_product=pg_fetch_array($res_product)) {
							echo "<tr class='danger'>";
							echo "<td style='font-size:11px'></td>";
							echo "<td style='font-size:13px'><b> Product : $row_product[name]</b></td>";
							echo "<td style='font-size:11px'></td>";
							echo "<td style='font-size:11px'></td>";
							echo "<td style='font-size:11px'></td>";
							echo "<td style='font-size:11px'></td>";
							...
							$var_product1="  and a.id_product='$row_product[id_product]' ";
