            ...
            <div class="portlet light bordered">
									<div class="portlet-title">
										<div class="caption">
											...
											<span class="caption-subject font-red-sunglo bold uppercase"> FORM EDIT PASSWORD </span>
						...
						<div class="portlet-body form">
							...
							<form action="<?php echo "module/actions_master.php?module=$module&pm=$pm&act=edit_profile"; ?>" id="form_sample_3" class="form-horizontal" method="POST" enctype="multipart/form-data">
								<div class="form-body">
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="input-group input-large margin-top-10">
											...
											<input type="text" name="nama_lengkap" id="nama_lengkap" value="<?php echo getNamaLengkap();?>" placeholder="Full Name ..." class="form-control" required/>
										</div>
										</div>
									</div>
									<div class="form-group">
										...
										* </span>
										...
										<div class="input-group input-large margin-top-10">
											...
											<input type="text" name="myemail" id="myemail" value="<?php echo getEmail();?>" placeholder="Email ..." class="form-control" required/>
										</div>
										</div>
									</div>
									<div class="form-group">
										...
										* </span>
										...
										<div class="input-group input-large margin-top-10">
											...
											<input type="text" name="tlp" id="tlp" value="<?php echo getTlp();?>" placeholder="Telepon ..." class="form-control" required/>
										</div>
										</div>
									</div>
									...
									<input type="hidden" name="id_karyawan" value="<?php echo getUsername();?>">
