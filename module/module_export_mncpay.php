                       ...
                       <div class="portlet light bordered">
									<div class="portlet-title">
										<div class="caption">
											...
											<span class="caption-helper">for Export Request MNC Pay ...</span>
										</div>
...
//alert (to);
	...
	if (from !='' && to !='' ){
				$("#kosong").hide();
				$(".excel").hide();
				var dataString1 ='from='+ from +'&to='+ to;
				...
				//alert (dataString1);	
					$.ajax
						({
							type: "POST",
							url: "module/ajax/ajax_export_req_mncpay.php",
							data: dataString1,
							cache: false,
