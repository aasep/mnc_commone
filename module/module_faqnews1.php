...
<!-- BEGIN SAMPLE PORTLET CONFIGURATION MODAL FORM-->
            ...
            <!-- MODAL INSERT -->
							...
							<form action="<?php echo "module/actions_master.php?module=$module&act=add_kategori_faq"; ?>" id="form_sample_3" class="form-horizontal" method="POST">
								<div class="form-body">
									...
									<div class="form-group">
										<label class="control-label col-md-3">Nama  FAQ  <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
             ...
             <a class="btn blue" data-toggle="modal" href="#basic">Add  FAQ  <i class="fa fa-plus"></i> </a> </br> </br>
...
?>
			...
			<!-- BEGIN EXAMPLE TABLE PORTLET-->
					<div class="portlet box blue-hoki">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Daftar  FAQ  
							</div>
							<div class="tools">
								<a href="javascript:;" class="reload">
								</a>
	...
	$('.detailDelete').click(function() {
		...
		var nama_kategori = $(this).attr('id-nama');
		  ...
		  //alert(nama_kategori);
			...
			$("#list-user").append( 
                '<tr>'+
				'<td>'+'<h5>Yakin Anda Akan Mendelete '+'<strong>' + nama_kategori +'</strong></h5>'+
