...
<!-- BEGIN SAMPLE PORTLET CONFIGURATION MODAL FORM-->
					...
					<div class="portlet light bordered">
									<div class="portlet-title">
										<div class="caption">
											...
											<span class="caption-subject font-red-sunglo bold uppercase"> Add Group Users </span>
							...
							<form action="<?php echo "module/actions_master.php?module=$module&act=add_group_user"; ?>" id="form_sample_3" class="form-horizontal" method="POST">
								<div class="form-body">
									...
									<div class="form-group">
										<label class="control-label col-md-3">Group User Name <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
									...
									<div class="form-group">
										<label class="control-label col-md-3">Initial <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
				...
				<!-- MODAL UPDATE-->
					...
					<div class="portlet light bordered">
									<div class="portlet-title">
										<div class="caption">
											<i class="icon-equalizer font-red-sunglo"></i>
											<span class="caption-subject font-red-sunglo bold uppercase"> Edit Group Users </span>
											<span class="caption-helper"> </span>
										</div>
										<div class="actions">
	...
	echo "<div class='alert alert-success alert-dismissable'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'></button><strong>Group User Added Successful ...! </strong> </div>";
     }
	if (isset($_GET['message']) && ($_GET['message']=="error")){
	echo "<div class='alert alert-danger alert-dismissable'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'></button><strong>Failed to Add Group User ...!</strong> </div>";
    }
	if (isset($_GET['message']) && ($_GET['message']=="success2")){
	echo "<div class='alert alert-success alert-dismissable'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'></button><strong>Group User Deleted Successful...! </strong> </div>";
     }
	if (isset($_GET['message']) && ($_GET['message']=="error2")){
	echo "<div class='alert alert-danger alert-dismissable'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'></button><strong>Failed to Delete Group User...!</strong> </div>";

	}
	if (isset($_GET['message']) && ($_GET['message']=="success3")){
	echo "<div class='alert alert-success alert-dismissable'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'></button><strong>Group User Updated Successful ...! </strong> </div>";
     }
	if (isset($_GET['message']) && ($_GET['message']=="error3")){
	echo "<div class='alert alert-danger alert-dismissable'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'></button><strong>Failed to Update Group User...!</strong> </div>";
			...
			<!-- BEGIN EXAMPLE TABLE PORTLET-->
					<div class="portlet light grey-steel bordered">
									<div class="portlet-title">
										<div class="caption">
											<i class="icon-equalizer font-red-sunglo"></i>
											<span class="caption-subject font-red-sunglo bold uppercase"> List OF Group Users </span>
											<span class="caption-helper"> </span>
										</div>
										<div class="actions">
						...
						<div class="portlet-body">
							...
							<?php
							$i=1;
                            $query="select * from group_type $var_q ";
							...
							echo "<td><a href='#'  data-toggle='modal' id-group='$row[id_group_type]' id-nama='$row[name]' id-inisial='$row[inisial]' data-target='#edit-modal' class='detailEdit' > <button class='btn default'>Edit</button></a> <a href='#'  data-toggle='modal' id-group='$row[id_group_type]' id-nama='$row[name]' data-target='#delete-modal' class='detailDelete' > <button class='btn red'>Delete</button></a></td>";
							echo "</tr>";
							$i++;
