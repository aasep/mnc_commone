...
$(document).ready( function() {
  	...
  	$('#my_product').dataTable({
		...
		"processing": true,
		"serverSide": true,
	    "sAjaxSource": "../commone/module/server_side/server_processing_my_product.php",
  	...
  	$('#my_promotion').dataTable({
		"bFilter": true,
		"bInfo": true,		
		"processing": true,
		"serverSide": true,
	    "sAjaxSource": "../commone/module/server_side/server_processing_my_promotion.php",
		//"fnServerParams": function (aoData) {
        	//var includeUsuallyIgnored = $("#include-checkbox").is(":checked");
        	//aoData.push({name: "id_pic", value: $("#id_pic").val()});
			//aoData.push({name: "action_status", value: action_status});
		...
		"order": [[ 0, "desc" ]]
						...
						<table class="table table-striped table-bordered table-hover" id="my_product" width="100%">
							<thead>
							<tr>
			...
			<div class="row">
				<div class="col-md-12 blog-page">
					<div class="row">
						...
						<table class="table table-striped table-bordered table-hover" id="my_promotion" width="100%">
							<thead>
							<tr>
...
/*
$('body').on('click', '.beritaProduk', function (){
...
//	$('.beritaProduk').click(function() {
	$('body').on('click', '.beritaProduk', function (){
		//var x = document.getElementsByClassName("beritaProduk").getAttribute("id-title");
...
//	$('.beritaPromosi').click(function() {
	$('body').on('click', '.beritaPromosi', function (){
