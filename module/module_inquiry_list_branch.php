...
$query1.=" where status='1' and id_cabang='".getIdCabang()."' and id_channel='".getIdChannel()."' and  to_char(date_sla, 'YYYY-MM-DD') >='".$current_date."' ";
...
$query2.=" where status='2' and id_cabang='".getIdCabang()."' and id_channel='".getIdChannel()."' and  to_char(date_sla, 'YYYY-MM-DD') >='".$current_date."' ";
...
$query3.=" where status='3' and id_cabang='".getIdCabang()."' and id_channel='".getIdChannel()."' ";
...
$query4.=" where status in ('1','2') and id_cabang='".getIdCabang()."' and id_channel='".getIdChannel()."' and  to_char(date_sla, 'YYYY-MM-DD') < '".$current_date."' ";
...
if (isset($_GET['act1']) ) {
	...
	switch ($_GET['act1']) {
		 case '1' : $varsrc= " where status='1' and id_cabang='".getIdCabang()."' and id_channel='".getIdChannel()."' and  to_char(date_sla, 'YYYY-MM-DD') >='".$current_date."'   "; $ket="Unprocessed"; break; //ticket_number
		 case '2' : $varsrc= " where status='2' and id_cabang='".getIdCabang()."' and id_channel='".getIdChannel()."' and  to_char(date_sla, 'YYYY-MM-DD') >='".$current_date."'  "; $ket="OnProgress"; break; //customer_name
		 case '3' : $varsrc= " where status='3' and id_cabang='".getIdCabang()."' and id_channel='".getIdChannel()."' "; $ket="Done"; break; //account_number
		 case '4' : $varsrc= " where status in ('1','2') and id_cabang='".getIdCabang()."' and id_channel='".getIdChannel()."' and  to_char(date_sla, 'YYYY-MM-DD') < '".$current_date."' "; $ket=" Exipred "; break;
		 //case '5' : $varsrc= " where status in ('1','2') and id_cabang='".getIdCabang()."' and  to_char(date_sla, 'YYYY-MM-DD') < '".$current_date."' "; $ket=" Exipred "; break; // credit_card_number
		 }
...
$(document).ready( function() {
  	...
  	$('#list_ticket').dataTable({
		...
		"processing": true,
		"serverSide": true,
	    "sAjaxSource": "../commone/module/server_side/server_processing_inquiry_list_branch.php?act1=<?php echo "$act1&srcby=$srcby&srckey=$srckey&module=$module&pm=$pm";?>",
     ...
     <div class="portlet light bordered">
									<div class="portlet-title">
										<div class="caption">
											...
											<span class="caption-subject font-red-sunglo bold uppercase">List Inquiry <?php echo getNamaCabang();?> </span>
