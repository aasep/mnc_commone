...
<?php
			...
			?>
					...
					<table class="table table-striped table-bordered table-hover" id="sample_2" width="100%">
							<thead>
							<tr class='active'>
								<th style="font-size:11px" width="5%" align="center">
									 No
								</th>
								<th style="font-size:11px" width="10%" align="center">
									 No. Tiket /<br>Tgl. Laporan 
								</th>
								<th  style="font-size:11px" width="10%" align="center">
									 Channel / Nama Nasabah
								</th>
								
								<th style="font-size:11px" width="28%" align="center">
									 Unit / Proses / Permasalahan
								</th>
								<th style="font-size:11px" width="7%" align="center">
									 Status
								</th>
								<th style="font-size:11px" width="8%" align="center">
									 Prioritas
								</th>
								<th style="font-size:11px" width="7%" align="center">
									 Batas Akhir
							...
							$i=1;
                            $query  =" select *,c.name as nama_unit, d.name as nama_proses, e.name as permasalahan, h.name as nama_channel,e.priority,e.satuan from laporan_kerja a  ";
							...
							echo "<td style='font-size:11px'><i class='fa fa-ticket'></i> <b>$row[ticket_number]</b><br><i class='fa fa-calendar'></i> ".date('d-m-Y H:i',strtotime($row['date_start']))."</td>";
							echo "<td style='font-size:11px'><i class='fa fa-space-shuttle'></i> <b>$row[nama_channel]</b><br><i class='fa fa-user'></i> <i>$row[customer_name]</i></td>";
							echo "<td style='font-size:11px'><b>$row[nama_unit]</b><br>$row[nama_proses]<br><i>$row[permasalahan]</i></td>";
