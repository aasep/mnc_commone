...
<!-- BEGIN SAMPLE PORTLET CONFIGURATION MODAL FORM-->
            ...
            <!-- MODAL INSERT -->
								...
								<div class="modal-dialog modal-lg">
									<div class="modal-content">
										<div class="modal-header">
											...
											<h4 class="modal-title">Add Mapping SLA</h4>
										</div>
						...
						<div class="portlet light bordered">
									<div class="portlet-title">
										<div class="caption">
											...
											<span class="caption-subject font-red-sunglo bold uppercase">Add Mapping SLA </span>
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="<?php echo "module/actions_master.php?module=$module&act=add_map_pua"; ?>" id="form_sample_3" class="form-horizontal" method="POST">
								<div class="form-body">
										...
										* </span>
										...
										<div class="col-md-5">
											<select class="form-control select2me" name="idpermasalahan" id="idpermasalahan" required>
												...
												<?php
												$query=" select * from master_case where id_case not in (select id_case from map_access) order by name asc ";
												$r_product=pg_query($connection,$query);
												while ($row1=pg_fetch_array($r_product)){
               ...
               <!-- MODAL EDIT -->
							...
							<div class="modal fade"  id="edit-modal" tabindex="-1"  aria-hidden="true"  role="dialog"  aria-labelledby="myModalLabel">
								<div class="modal-dialog modal-lg">
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
											<h4 class="modal-title">Edit Mapping SLA</h4>
										</div>
										<div class="modal-body">
											<!-- BEGIN VALIDATION STATES-->
						...
						<div class="portlet light bordered">
									<div class="portlet-title">
										<div class="caption">
											<i class="icon-equalizer font-red-sunglo"></i>
											<span class="caption-subject font-red-sunglo bold uppercase">Edit Mapping SLA </span>
											<span class="caption-helper"> </span>
										</div>
										<div class="actions">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="<?php echo "module/actions_master.php?module=$module&act=edit_map_pua"; ?>" id="form_sample_2" class="form-horizontal" method="POST">
								<div class="form-body">
									<div class="alert alert-danger display-hide">
										<button class="close" data-close="alert"></button>
										Please Fill Form Below Completely ... !
             ...
             <div class="modal fade bs-modal-lg" id="delete-modal" tabindex="-1" role="dialog" aria-hidden="true" aria-labelledby="myModalLabel">
								<div class="modal-dialog modal-lg" >
									<div class="modal-content">
										...
										<div class="modal-body">
							<form action="<?php echo "module/actions_master.php?module=$module&act=delete_map_pua"; ?>" class="form-horizontal" method="POST">
             ...
             <a class="btn blue" data-toggle="modal" href="#basic">Add Mapping SLA <i class="fa fa-plus"></i> </a> </br> </br>
			...
			<!-- BEGIN EXAMPLE TABLE PORTLET-->
						...
						<div class="portlet light bordered">
									<div class="portlet-title">
										<div class="caption">
											<i class="icon-equalizer font-red-sunglo"></i>
											<span class="caption-subject font-red-sunglo bold uppercase">List Of  Mapping SLA </span>
											<span class="caption-helper"> </span>
										</div>
										<div class="actions">
						...
						<div class="portlet-body">
							...
							<?php
							$i=1;
                            $query  =" select z.id,a.id_product, a.name as nama_produk, b.id_unit, b.name as nama_unit, c.id_process, c.name as nama_proses, ";
                            $query .=" d.id_case, d.name as nama_kasus from map_access z ";
							...
							echo "<td width='10%'>$row[nama_produk]</td>";
							echo "<td width='70%'><b>$row[nama_unit]</b> <br> <b>$row[nama_proses]</b> <br> <i>$row[nama_kasus]</i> </td>";
							
							echo "<td width='20%'><a href='#'  data-toggle='modal' id-access='$row[id]' id-product='$row[id_product]' id-namaproduk='$row[nama_produk]' id-unit='$row[id_unit]' id-namaunit='$row[nama_unit]' id-process='$row[id_process]' id-namaproses='$row[nama_proses]' id-case='$row[id_case]' id-namakasus='$row[nama_kasus]'  data-target='#edit-modal' class='detailEdit' > <button class='btn default'>Edit</button></a> <a href='#'  data-toggle='modal' id-access='$row[id]' id-product='$row[id_product]' id-namaproduk='$row[nama_produk]' id-unit='$row[id_unit]' id-namaunit='$row[nama_unit]' id-process='$row[id_process]' id-namaproses='$row[nama_proses]' id-case='$row[id_case]' id-namakasus='$row[nama_kasus]' data-target='#delete-modal' class='detailDelete' > <button class='btn red'>Delete</button></a></td>";
							echo "</tr>";
							$i++;
	...
	$('.detailDelete').click(function() {
		...
		var nama_case = $(this).attr('id-namakasus');
		  ...
		  //alert(id_user);
			...
			$("#list-user").append( 
                '<tr>'+
				'<td>'+'<h5><div class="alert alert-warning alert-dismissable"><b>Sure, You Will Delete Relation  :</b> <p></p><p>'+'<strong> Product : </strong><i>' + nama_product + '</i>, <strong>Unit : </strong><i>' +nama_unit +'</i>, <strong>Process : </strong> <i>'+nama_process+'</i>, <strong>Case : </strong><i>'+nama_case+'</i></p></div></h5>'+
