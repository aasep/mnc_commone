...
<!-- BEGIN SAMPLE PORTLET CONFIGURATION MODAL FORM-->
            ...
            <!-- MODAL INSERT -->
								...
								<div class="modal-dialog modal-lg">
									<div class="modal-content">
										<div class="modal-header">
											...
											<h4 class="modal-title">Add Master BI Case</h4>
										</div>
					...
					<div class="portlet light bordered">
									<div class="portlet-title">
										<div class="caption">
											...
											<span class="caption-subject font-red-sunglo bold uppercase">Add BI Case </span>
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="<?php echo "module/actions_master.php?module=$module&act=add_casebi"; ?>" id="form_sample_3" class="form-horizontal" method="POST">
								<div class="form-body">
									...
									<div class="form-group">
										<label class="control-label col-md-3">Case BI Code<span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<input type="text" name="kd_case" id="kd_case" placeholder="Case BI Code.." class="form-control" required/>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">Case BI Name <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<input type="text" name="nama_case" id="nama_case" placeholder="Case BI Name.." class="form-control" required/>
										</div>
									</div>
							...
							<div class="modal fade"  id="edit-modal" tabindex="-1"  aria-hidden="true"  role="dialog"  aria-labelledby="myModalLabel">
								<div class="modal-dialog modal-lg">
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
											<h4 class="modal-title">Edit Master BI Case</h4>
										</div>
										<div class="modal-body">
											<!-- BEGIN VALIDATION STATES-->
					<div class="portlet light bordered">
									<div class="portlet-title">
										<div class="caption">
											<i class="icon-equalizer font-red-sunglo"></i>
											<span class="caption-subject font-red-sunglo bold uppercase">Edit BI Case </span>
											<span class="caption-helper"> </span>
										</div>
										<div class="actions">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="<?php echo "module/actions_master.php?module=$module&act=edit_casebi"; ?>" id="form_sample_2" class="form-horizontal" method="POST">
								<div class="form-body">
									<div class="alert alert-danger display-hide">
										<button class="close" data-close="alert"></button>
										Please Fill Form Below Completely ... !
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
											<input type="text" name="ed_kd" id="ed_kd" placeholder="Case BI Code.." class="form-control" required/>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">Case BI Name<span class="required">
										* </span>
										...
										<div class="col-md-4">
											<input type="text" name="ed_nama" id="ed_nama"  placeholder="Case BI Name.." class="form-control" required/>
										</div>
									</div>
             ...
             <div class="modal fade bs-modal-lg" id="delete-modal" tabindex="-1" role="dialog" aria-hidden="true" aria-labelledby="myModalLabel">
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
											<h4 class="modal-title" id="myModalLabel"><strong>Delete BI Case</strong></h4>
										</div>
										<div class="modal-body">
							<form action="<?php echo "module/actions_master.php?module=$module&act=delete_casebi"; ?>" class="form-horizontal" method="POST">
             ...
             <a class="btn blue" data-toggle="modal" href="#basic">Add Master BI Case <i class="fa fa-plus"></i> </a> </br> </br>
			...
			<!-- BEGIN EXAMPLE TABLE PORTLET-->
					<div class="portlet light bordered">
									<div class="portlet-title">
										<div class="caption">
											<i class="icon-equalizer font-red-sunglo"></i>
											<span class="caption-subject font-red-sunglo bold uppercase">List Master BI Case </span>
											<span class="caption-helper"> </span>
										</div>
										<div class="actions">
						...
						<div class="portlet-body">
							...
							<?php
							$i=1;
                            $query =" select * from bi_case order by name asc ";
							...
							echo "<tr>";
							echo "<td>$i</td>";
							echo "<td>$row[kd_causebi]</td>";
							echo "<td>$row[name]</td>";
							echo "<td>".date('d-m-Y H:i',strtotime($row['adddt']))."</td>";
							echo "<td>$row[addby]</td>";
							echo "<td><a href='#'  data-toggle='modal' id-causebi='$row[id_causebi]'  kd-causebi='$row[kd_causebi]' id-nama='$row[name]'  data-target='#edit-modal' class='detailEdit' > <button class='btn default'>Edit</button></a> <a href='#'  data-toggle='modal' id-causebi='$row[id_causebi]' kd-causebi='$row[kd_causebi]' id-nama='$row[name]' data-target='#delete-modal' class='detailDelete' > <button class='btn red'>Delete</button></a></td>";
							echo "</tr>";
							$i++;
	...
	$('.detailDelete').click(function() {
		...
		var nama_causebi = $(this).attr('id-nama');
		  ...
		  //alert(id_user);
			...
			$("#list-user").append( 
                '<tr>'+
				'<td>'+'<h5><div class="alert alert-warning alert-dismissable"> Sure, You Will Delete '+'<strong>' + nama_causebi +'</strong>'+ ' with CODE : <b> '+ kd_causebi +'</b></div></h5>'+
...
jQuery(document).ready(function () {
    ...
    $('#form_sample_3').validate({
        ...
        messages: {
        	nama_case: {
                 required: "<span class='label label-warning'><i>Nama Case BI Harus diisi ...! </i></span>"
            },
            kd_case: {
                 required: "<span class='label label-warning'><i>Kode Case BI Harus diisi ...! </i></span>",
