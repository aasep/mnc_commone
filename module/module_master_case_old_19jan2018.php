					...
					<div class="portlet light bordered">
						...
						<div class="portlet-body">
							...
							<tr>
								...
								<th>
									 Case Name / BI Product /  BI Case
								</th>
								
								<th>
									 SLA (Satuan) / Mandatory File
								</th>
								
								<th>
									 Prioritas / Stat.Pembayaran
								</th>
							...
							<?php
							$i=1;
                            $query  =" select a.id_case, a.name, a.sla, a.satuan, a.priority,b.name as nama_bicase,c.name as nama_biproduct,c.id_productbi,b.id_causebi,a.stat_pmb,a.flag_mandatory from master_case a ";
                            $query .=" left join bi_case b on b.id_causebi=a.id_causebi ";
                            $query .=" left join bi_product c on c.id_productbi=a.id_productbi order by a.name asc";
							...
							echo "<td align='center'>$prioritas<br> <br>$status_pmb </td>";
							echo "<td><a href='#'  data-toggle='modal' id-case='$row[id_case]' id-stat_pmb='$row[stat_pmb]' id-ismandatory='$row[flag_mandatory]' id-nama='$row[name]' id-sla='$row[sla]' id-priority='$row[priority]' id-satuan='$row[satuan]' id-bicase='$row[id_causebi]' id-namabicase='$row[nama_bicase]  id-biproduct='$row[id_productbi]' id-namabiproduct='$row[nama_biproduct]' data-target='#edit-modal' class='detailEdit' > <button class='btn default'>Edit</button></a> <a href='#'  data-toggle='modal' id-case='$row[id_case]' id-name='$row[name]' id-bicase='$row[id_causebi]' id-namabicase='$row[nama_bicase]  id-biproduct='$row[id_productbi]' id-namabiproduct='$row[nama_biproduct]' data-target='#delete-modal' class='detailDelete' > <button class='btn red'>Delete</button></a></td>";
							echo "</tr>";
							$i++;
