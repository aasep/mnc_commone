...
<!-- BEGIN SAMPLE PORTLET CONFIGURATION MODAL FORM-->
            ...
            <!-- MODAL INSERT -->
								...
								<div class="modal-dialog modal-lg">
									<div class="modal-content">
										<div class="modal-header">
											...
											<h4 class="modal-title">Add Master Inquiry</h4>
										</div>
					...
					<div class="portlet light bordered">
									<div class="portlet-title">
										<div class="caption">
											...
											<span class="caption-subject font-red-sunglo bold uppercase">Add Inquiry </span>
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="<?php echo "module/actions_master.php?module=$module&act=add_report"; ?>" id="form_sample_3" class="form-horizontal" method="POST">
								<div class="form-body">
									...
									<div class="form-group">
										<label class="control-label col-md-3">Nama Laporan <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<input type="text" name="nama_laporan" id="nama_laporan" placeholder="Nama Laporan" class="form-control" required/>
										</div>
									</div>
							...
							<div class="modal fade"  id="edit-modal" tabindex="-1"  aria-hidden="true"  role="dialog"  aria-labelledby="myModalLabel">
								<div class="modal-dialog modal-lg">
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
											<h4 class="modal-title">Edit Master Inquiry</h4>
										</div>
										<div class="modal-body">
											<!-- BEGIN VALIDATION STATES-->
					<div class="portlet light bordered">
									<div class="portlet-title">
										<div class="caption">
											<i class="icon-equalizer font-red-sunglo"></i>
											<span class="caption-subject font-red-sunglo bold uppercase">Edit Inquiry </span>
											<span class="caption-helper"> </span>
										</div>
										<div class="actions">
							...
							<!-- BEGIN FORM-->
							<form action="<?php echo "module/actions_master.php?module=$module&act=edit_report"; ?>" id="form_sample_2" class="form-horizontal" method="POST">
								<div class="form-body">
									<div class="alert alert-danger display-hide">
										<button class="close" data-close="alert"></button>
										Please Fill Form Below Completely ... !
									...
									<div class="form-group">
										<label class="control-label col-md-3">Inquiry Name <span class="required">
										* </span>
										</label>
										<div class="col-md-4">
											<input type="text" name="ed_nama" id="ed_nama"  placeholder="Nama Laporan" class="form-control" required/>
										</div>
									</div>
             ...
             <div class="modal fade bs-modal-lg" id="delete-modal" tabindex="-1" role="dialog" aria-hidden="true" aria-labelledby="myModalLabel">
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
											<h4 class="modal-title" id="myModalLabel"><strong>Delete Inquiry</strong></h4>
										</div>
										<div class="modal-body">
							<form action="<?php echo "module/actions_master.php?module=$module&act=delete_report"; ?>" class="form-horizontal" method="POST">
             ...
             <a class="btn blue" data-toggle="modal" href="#basic">Add Master Inquiry <i class="fa fa-plus"></i> </a> </br> </br>
			...
			<!-- BEGIN EXAMPLE TABLE PORTLET-->
					<div class="portlet light bordered">
						...
						<div class="portlet-body">
							...
							echo "<td><a href='#'  data-toggle='modal' id-report='$row[id_report]' id-nama='$row[name]'  data-target='#edit-modal' class='detailEdit' > <button class='btn default'>Edit</button></a> <a href='#'  data-toggle='modal' id-report='$row[id_report]' id-nama='$row[name]' data-target='#delete-modal' class='detailDelete' > <button class='btn red'>Delete</button></a></td>";
							echo "</tr>";
							$i++;
...
$(document).ready(function() {
	...
	$('.detailDelete').click(function() {
		...
		var nama_laporan = $(this).attr('id-nama');
    
		  //alert(id_user);
			$("#list-user").empty();
			$("#list-user").append( 
                '<tr>'+
				'<td>'+'<h5>Yakin Anda Akan Mendelete '+'<strong>' + nama_laporan +'</strong></h5>'+
	...
	$('.detailEdit').click(function() {
    	...
    	document.getElementById('ed_nama').value=nama_laporan;

		  //alert(id_user);
			$("#list-user2").empty();
			$("#list-user2").append( '<input type="hidden" name="id_report" value="'+id_report+'">');
...
jQuery(document).ready(function () {
    ...
    $('#form_sample_3').validate({
        ...
        messages: {
        	nama_laporan: {
                 required: "<span class='label label-warning'><i>Nama Laporan Harus diisi ...! </i></span>"
            }
        },
