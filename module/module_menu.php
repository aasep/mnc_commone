					...
					<div class="portlet light bordered">
									<div class="portlet-title">
										<div class="caption">
											...
											<span class="caption-subject font-red-sunglo bold uppercase">Add Menu</span>
										...
										* </span>
										...
										<div class="col-md-4">
											<select class="form-control" name="parent" id="parent">
												...
												<?php
												$query_parent="select * from master_menu where parent='0' order by name asc";
												$result_parent=pg_query($connection, $query_parent);
												while ($row_parent=pg_fetch_array($result_parent)){

													echo "<option value='$row_parent[id_menu]'>$row_parent[name]</option>"; 
										...
										<div class="col-md-4">
											<select class="form-control" name="parent" id="parent">
												...
												while ($row_parent=pg_fetch_array($result_parent)){
													...
													echo "<option value='$row_parent[id_menu]' selected='selected'>$row_parent[name]</option>"; 
													} else {
													echo "<option value='$row_parent[id_menu]' >$row_parent[name]</option>"; 
												        }    
												   }
			...
			<!-- BEGIN EXAMPLE TABLE PORTLET-->
					<div class="portlet light bordered">
									<div class="portlet-title">
										<div class="caption">
											<i class="icon-equalizer font-red-sunglo"></i>
											<span class="caption-subject font-red-sunglo bold uppercase">List Of Menu</span>
											<span class="caption-helper"> </span>
										</div>
										<div class="actions">
						...
						<div class="portlet-body">
							...
							$i=1;
							$no_parent=1;
                            $query="select * from master_menu where parent='0' order by id_menu asc ";
							...
							echo "<td width='50%'><b>$row[name]</b></td>";
							echo "<td width='5%'>".$row['parent']."</td>";
							echo "<td width='10%'>$row[id_menu]</td>";
							echo "<td width='30%'><a class='btn default' href='$page&act=edit_menu&nama_menu=$row[name]&parent=$row[parent]&id_menu=$row[id_menu]'>edit</a> <a href='#'  data-toggle='modal' id-menu='$row[id_menu]' id-nama='$row[name]' data-target='#delete-modal' class='detailDelete' > <button class='btn red'>Delete</button></a></td>";
							echo "</tr>";

                            $query2="select * from master_menu where parent='$row[id_menu]' order by name asc ";
                            $result2=pg_query($connection,$query2);
                            while ($row2=pg_fetch_array($result2)) {

                            echo "<tr>";
							echo "<td width='5%'>$no_parent . $submenu </td>";
							echo "<td width='50%'>$row2[name]</td>";
							echo "<td width='5%'>".$row2['parent']."</td>";
							echo "<td width='10%'>$row2[id_menu]</td>";
							echo "<td width='30%'><a class='btn default' href='$page&act=edit_menu&nama_menu=$row2[name]&parent=$row2[parent]&id_menu=$row2[id_menu]'>edit</a> <a href='#'  data-toggle='modal' id-menu='$row2[id_menu]' id-nama='$row2[name]' data-target='#delete-modal' class='detailDelete' > <button class='btn red'>Delete</button></a></td>";
							echo "</tr>";
                              $submenu++;
                            }
