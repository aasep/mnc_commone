			...
			?>
					 <div class="portlet light bordered">
						...
						<div class="portlet-body">
							...
							echo "<td style='font-size:11px' align='center'> <a href='$page&ext=detail&tn=$row[ticket_number]&cat=$_GET[act1]&ds=$_GET[iDisplayStart]' target='_blank'  > <button class='btn blue' type='button'> <i class='fa fa-check-circle'></i> <b> Detail</b> </button> </a> <br> <br> </td>";
							//<a href='module/convert_pdf_lapker.php?module=$module&pm=$pm&tn=$row[ticket_number]' target='_blank' > <button class='btn red ' type='button'> Print <span aria-hidden='true' class='icon-printer'></span> </button></a>
							echo "</tr>";
							$i++;
...
switch ($row_lap['status']) {
		 ...
		 case '5' : $status= " <button type='button' class='btn btn-circle btn-success' disabled>  <span class='label label-success'> </i> <b> Cancel </b> </span> </button> "; break;
		  //case '4' : $varsrc= " where credit_card_number='$srckey' "; break; // credit_card_number
		 }
